...
if ($("#txtrut").val()=="")
  ...
  if ($("#txtrazon_social").val()=="")
  {
    ...
    dir_url = "registrar_cliente_db.php";
    $.ajax({
           type: "POST",
           url: dir_url,
           ...
           {               
              ...
              if (data>0)
              {
                 enviar($("#txtrut").val(), $("#txtrazon_social").val(), data);
              }
              else
              {
...
<p>&nbsp;</p> 
 ...
 <table class="" width="90%" id="tblGuardar" align="center">  
  <tr>
    <td width="30%">&nbsp;</td>
    <td width="40%" align="center"><INPUT id="cmdGuardar" type="button" value="Registrar Cliente"   class="btn btn-primary" onclick="GuardarRegistro();"/></td>
    <td width="30%">&nbsp;</td>
  </tr>
</table>
</form>
