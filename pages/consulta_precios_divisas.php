...
if (isset($_SESSION['username']) && isset($_SESSION['userid']) ){
    ...
    $link=crearConexion();
    $listado="SELECT a.*, b.simbologia FROM tbl_precios_divisa a, tbl_divisas b WHERE id_divisa=fk_divisa  order by a.fechahora_actulizacion asc";
...
<div class="portada">
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Divisas</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                    ...
                    <div class="panel panel-default">
                      ...
                      ?>                 
                                    <tr class="gradeA">
                                        ...
                                        <td><?php echo $reg['fechahora_actulizacion'];?></td>
                                        <td><?php echo $reg['monto_actualizacion'];?></td>
                                        
                                        
                                        <td><?php echo $reg['simbologia'];?></td>
