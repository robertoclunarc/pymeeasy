...
if (isset($_SESSION['username']) && isset($_SESSION['userid']) ){
  ...
  include("../BD/conexion.php");
    ...
    $fieldset= "";
    if ($vista=='vw_ventas'){
        $listado1="SELECT idnota FROM tbl_ventas WHERE idventa=".$idventa;
        ...
        $listado1="SELECT
        tbl_detalles_ventas.fkventa,
        tbl_detalles_ventas.fkproducto,
        tbl_detalles_ventas.cantidad,
        tbl_detalles_ventas.medida,
        tbl_detalles_ventas.precio,
        tbl_detalles_ventas.precio_total,
        ...
        $etiqueta1="Venta ID. ".$idventa;
        $etiqueta2="Elementos Basicos para la Venta ID. ".$idventa.". FECHA: ".$fecha;
    ...
    else
    {
        ...
        CONCAT(tbl_productos.descripcion_prod,' ',tbl_productos.marca) AS descripcion_prod,
        tbl_productos.excepto_iva,
        tbl_detalles_notas_entrega.fknota as fkventa,
        ...
        WHERE tbl_detalles_notas_entrega.fknota=".$idventa;
        $result1 = $link->query($listado1);
        $cant=$result1->num_rows;
        $etiqueta1="Nota Entrega ID. ".$idventa;
        $etiqueta2="Elementos Basicos para la Venta. FECHA: ".$fecha;
...
if ($("#hddcontador").val()=="0")
  ...
  var dir_url="update_ventas_db.php";
  if ($("#hddvista").val()!="vw_ventas")
    dir_url="registrar_ventas_db.php?idnota="+$("#hddidventa").val();
...
<div class="portada">
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><?php echo  $etiqueta1; ?></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
 ...
 <input name='hddvista' id='hddvista' type='hidden' value='<?php echo $vista; ?>'/>
 <input name='cbofkvendedor' type='hidden' value='<?php echo $idvendedor; ?>'/>
 <input name='hddfkcliente'  type='hidden' value='<?php echo $idcliente; ?>'/>
                      ...
                      ?>
                        <tr>                     
                            ...
                            <td width="25%"><?php echo $reg1['precio_total']; ?>
                              ...
                              <input name='fkproducto[]' type='hidden' value='<?php echo $reg1['fkproducto']; ?>'/>
                              <input name='cantidad[]' type='hidden' value='<?php echo $reg1['cantidad']; ?>'/>
                              <input name='medida[]' type='hidden' value='<?php echo $reg1['medida']; ?>'/>
                              <input name='precio[]' type='hidden' value='<?php echo $reg1['precio']; ?>'/>
                              <?php if ($vista!='vw_ventas'){ ?>
                                <input name='preciofact[]' type='hidden' value='<?php echo $reg1['precio_factura']; ?>'/>
                                <input name='preciove[]' type='hidden' value='<?php echo $reg1['preciove']; ?>'/>
                              <?php } ?>                            
                            </td>
                        </tr>
                      <?php                    
                        ...
                        <tr>                     
                            ...
                            <td>
                              ...
                              <fieldset <?php echo $fieldset; ?>>
                                  ...
                                  <div class="checkbox">
                                        <label>
                                            <input type="checkbox" id="chkiva" name="chkiva" <?php echo $aplica_iva; ?> onclick="aplicar_iva()" value="<?php echo $iva; ?>">Aplicar Iva <?php echo $iva.'%'; ?>
                                        </label>
                                  </div>
...
<p>&nbsp;</p>
<?php if ($idnota=='' && ($estatus_venta=='PENDIENTE'  || $vista!='vw_ventas')){ ?>
