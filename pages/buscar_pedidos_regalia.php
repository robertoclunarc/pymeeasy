...
{  
    ...
    window.opener.CargarCombo(window.opener.document.getElementById('cbofkproducto'), "cargar_combo_db.php?tabla=vw_productos_pedidos&campo1=fkproducto&campo2=producto&selected=0&where=fkpedido&condi="+id+"&firsttext=[Elija un producto]");
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                      ...
                      ?>                 
                                    <tr class="gradeA">
                                        <td><A href="#" onclick="enviar('<?php echo $reg['razon_social'];?>',<?php echo $reg['idpedido'];?>)" title=""><IMG SRC="images/note.png" WIDTH="20px" HEIGHT="20px"></A></td> 
