...
function ventanaAct2(){
  ...
  posicion_x=(screen.width/2)-(wi/2); 
  posicion_y=(screen.height/2)-(he/2);   
  var ventana = window.open('imp_reporte_inventario.php?fechaini='+fechaini+'&fechafin='+fechafin+'&idp='+idp, "Reporte de Inventario", "width="+wi+",height="+he+",menubar=NO,toolbar=NO,directories=NO,scrollbars=YES,resizable=YES,left="+posicion_x+",top="+posicion_y+""); 
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Elementos Basicos de Busqueda para el Inventario
                        </div>
...
<table width="90%">     
    <tr>
      ...
      <td><div class="form-group input-group">
          <input readonly="" name="txtproducto" id="txtproducto" type="text" class="form-control">
