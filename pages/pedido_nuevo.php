...
if ($("#hddcontador").val()=="0")
  {
    ...
    dir_url = "registrar_pedido_db.php";
    $.ajax({
           type: "POST",
           url: dir_url,
...
function ventanaAct(){
    ...
    var ventana = window.open('buscar_proveedor_pedido.php', "Buscar Proveedor", "width="+wi+",height="+he+",menubar=NO,toolbar=NO,directories=NO,scrollbars=YES,resizable=YES,left="+posicion_x+",top="+posicion_y+"");    
 }
//(*--------------------------------------------*)
...
VerificAgregar($("#cbofkproducto"));
  ...
  CargarCombo($("#cbofkproducto"), "cargar_combo_db.php?tabla=vw_productos&campo1=idproducto&campo2=descripcion&selected=0&orderby=descripcion&firsttext=[Elija un producto]");
...
<div class="portada">
 ...
 <input name='hddfkproveedor' id='hddfkproveedor' type='hidden' value=''/>
...
<table class="table" width="90%">
  <tbody>
    <tr>
        ...
        <td width="80%">
          <div class="form-group input-group">       
              <input type="text" placeholder="Proveedor" class="form-control"  id="txtrazon_social" >
    ...
    <tr>
        ...
        <td width="80%"><input name="txtrut" id="txtrut" type="text" class="form-control" style="z-index: 0;" onkeypress="VerificarEnter(event);"></td>
    </tr>
