...
if ($("#txtrut").val()=="")
  ...
  if ($("#txtrazon_social").val()=="")
  {
    ...
    dir_url = "actualizar_proveedor_db.php";
    $.ajax({
           type: "POST",
           url: dir_url,
...
function IrProveedor(rut)
{
  if (rut!='')
    {
      url="cargar_datos_proveedor.php?rut=" + rut; 
...
function ventanaAct(){
    ...
    var ventana = window.open('buscar_proveedor.php', "Buscar Proveedor", "width="+wi+",height="+he+",menubar=NO,toolbar=NO,directories=NO,scrollbars=YES,resizable=YES,left="+posicion_x+",top="+posicion_y+"");    
 }
...
<div class="portada">
    ...
    <div id="wrapper">
      ...
      <input name='hddidproveedor' id='hddidproveedor' type='hidden'/>
    ...
    <tr>
      ...
      <td width="70%"><div class="form-group input-group">
          ...
          <span class="input-group-btn">
              <button class="btn btn-default" onclick="IrProveedor($(txtrut).val());" type="button"><i class="fa fa-search"></i>
              </button>
          </span>
      </div></td>      
    </tr>
...
<table  width="90%"> 
    ...
    <tr>
      <td><label>E-Mail:</label></td>
       <td> &nbsp;</td>
     <td><INPUT type="text" id="txtemail" name="txtemail"  width="100%" class="form-control"/></td> 
    </tr>
   <tr>
      <td> &nbsp;</td>
       <td> &nbsp;</td>
    ...
    <tr>
      <td><label>Estatus:</label></td>
       <td> &nbsp;</td>
     <td><select id="cboestatus_prov" name="cboestatus_prov" class="form-control">
...
<table class="" width="90%" id="tblGuardar" align="center">  
  <tr>
    <td width="30%">&nbsp;</td>
    <td width="40%" align="center"><INPUT id="cmdGuardar" type="button" value="Actualizar Proveedor" class="btn btn-primary" onclick="GuardarRegistro();"/></td>
    <td width="30%">&nbsp;</td>
  </tr>
</table>
<p>&nbsp;</p>
