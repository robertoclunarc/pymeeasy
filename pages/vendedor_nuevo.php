...
if ($("#txtrut").val()=="")
  ...
  if ($("#txtrazon_social").val()=="")
  {
    ...
    dir_url = "registrar_vendedor_db.php";
    $.ajax({
           type: "POST",
           url: dir_url,
         ...
         if (data>0)
          {
            alert("El Vendedor Ha Sido Registrado Correctamente!");
...
<p>&nbsp;</p> 
 ...
 <table class="" width="90%" id="tblGuardar" align="center">  
  <tr>
    <td width="30%">&nbsp;</td>
    <td width="40%" align="center"><INPUT id="cmdGuardar" type="button" value="Registrar Vendedor" class="btn btn-primary" onclick="GuardarRegistro();"/></td>
    <td width="30%">&nbsp;</td>
  </tr>
</table>
</form>
