...
if ($("#txtrut").val()=="")
  ...
  if ($("#txtrazon_social").val()=="")
  {
    ...
    dir_url = "actualizar_cliente_db.php";
    $.ajax({
           type: "POST",
           url: dir_url,
...
{
    if (e.keyCode == 13) {
        Ircliente($(txtrut).val());        
    }
}
//(*--------------------------------------------*)
function Ircliente(rut)
{
  if (rut!='')
    {
      url="cargar_datos_cliente.php?rut=" + rut; 
...
function ventanaAct(){
    ...
    var ventana = window.open('buscar_clientes.php', "Buscar Cliente", "width="+wi+",height="+he+",menubar=NO,toolbar=NO,directories=NO,scrollbars=YES,resizable=YES,left="+posicion_x+",top="+posicion_y+"");    
 }
    ...
    <tr>
      ...
      <td width="70%"><div class="form-group input-group">
          ...
          <span class="input-group-btn">
              <button class="btn btn-default" onclick="Ircliente($(txtrut).val());" type="button"><i class="fa fa-search"></i>
              </button>
          </span>
      </div></td>      
    </tr>
...
<table  width="90%"> 
    ...
    <tr>
      <td><label>Estatus:</label></td>
       <td> &nbsp;</td>
     <td><select id="cboestatus_cliente" name="cboestatus_cliente" class="form-control">
...
<table class="" width="90%" id="tblGuardar" align="center">  
  <tr>
    <td width="30%">&nbsp;</td>
    <td width="40%" align="center"><INPUT id="cmdGuardar" type="button" value="Actualizar Cliente" class="btn btn-primary" onclick="GuardarRegistro();"/></td>
    <td width="30%">&nbsp;</td>
  </tr>
</table>
<p>&nbsp;</p>
