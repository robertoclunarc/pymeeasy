...
FROM
tbl_cierres_diarios_inv
INNER JOIN tbl_productos ON tbl_cierres_diarios_inv.fkproducto = tbl_productos.idproducto
ORDER BY
tbl_cierres_diarios_inv.fecha DESC";
...
<head>
    ...
    <title>Cargas de Inventario</title>
...
function enviar(idprod){
    window.location="cargar_inventario.php?idprod="+idprod;  
 }
</script>
</head>
...
<div class="portada">
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Cargas de Inventario</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Data General de del Cierre Diario de Inventario
                        </div>
                        <!-- /.panel-heading -->
