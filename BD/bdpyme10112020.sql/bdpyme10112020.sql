...
-- Tiempo de generación: 10-11-2020 a las 14:53:54
...
--
-- Volcado de datos para la tabla `tbl_abonos`
--
...
(212, 'Nuevo inicio de sesion', 'rlunar', '2020-11-10 13:16:02'),
(213, 'Actualizacion de Datos de Empresa', 'rlunar', '2020-11-10 14:04:40'),
(214, 'Actualizacion del registro Vendedor: --', 'rlunar', '2020-11-10 14:05:41'),
(215, 'Actualizacion del registro Vendedor: N/A', 'rlunar', '2020-11-10 14:06:09');
...
--
-- Disparadores `tbl_cierres_diarios_inv`
--
DELIMITER $$
...
--
-- Volcado de datos para la tabla `tbl_cuentas_cobrar`
--
...
--
-- Disparadores `tbl_cuentas_cobrar`
--
DELIMITER $$
...
--
-- Volcado de datos para la tabla `tbl_cuentas_pagar`
--
...
--
-- Volcado de datos para la tabla `tbl_detalles_pedidos`
--
...
--
-- Disparadores `tbl_detalles_pedidos`
--
DELIMITER $$
...
--
-- Volcado de datos para la tabla `tbl_detalles_ventas`
--
...
--
-- Disparadores `tbl_detalles_ventas`
--
DELIMITER $$
...
--
-- Estructura de tabla para la tabla `tbl_divisas`
--
...
--
-- Volcado de datos para la tabla `tbl_divisas`
--

INSERT INTO `tbl_divisas` (`id_divisa`, `nombre_divisa`, `simbologia`) VALUES
(1, 'Dolar', '$');
...
--
-- Volcado de datos para la tabla `tbl_modalidades_pagos`
--
...
(16.00, 'INRECA', 'J-40959190-5', 'Unare 2', 'Guayana', 'Puerto Ordaz', 'Eglis Martinez', '0414-', 0.00);
...
--
-- Estructura de tabla para la tabla `tbl_precios_divisa`
--

CREATE TABLE `tbl_precios_divisa` (
  `idprecio_divisa` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `tbl_precios_divisa`
--

INSERT INTO `tbl_precios_divisa` (`idprecio_divisa`, `fechahora_actulizacion`, `monto_actualizacion`, `fk_divisa`) VALUES
(1, '2020-11-10 09:00:01', 554995.72, 1),
(2, '2020-11-10 13:00:01', 567295.42, 1);
...
--
-- Volcado de datos para la tabla `tbl_precios_ventas_vendedores`
--
...
--
-- Disparadores `tbl_precios_ventas_vendedores`
--
DELIMITER $$
...
('rlunar', '81dc9bdb52d04dc20036dbd8313ed055', 'Roberto Lunar', 1, 'roberto_lunar@yahoo.', '-', '-', '-', '-', 'ACTIVO');
...
-- (Véase abajo para la vista actual)
--
CREATE TABLE `vw_cuentas_cobrar` (
`idcuenta_cob` int(11)
,`fkventa` int(11)
...
-- (Véase abajo para la vista actual)
--
CREATE TABLE `vw_precios_productos_blt` (
...
-- (Véase abajo para la vista actual)
--
CREATE TABLE `vw_precios_productos_unit` (
`descripcion_precio` varchar(46)
,`precio` double(11,2)
,`fkproducto` int(11)
);
...
--
-- Estructura Stand-in para la vista `vw_precio_actual_divisa`
-- (Véase abajo para la vista actual)
--
CREATE TABLE `vw_precio_actual_divisa` (
`idprecio_divisa` int(11)
,`fechahora_actulizacion` datetime
,`monto_actualizacion` double(11,2)
);
...
-- (Véase abajo para la vista actual)
--
CREATE TABLE `vw_productos_pedidos` (
`fkproducto` int(11)
,`fkpedido` int(11)
,`producto` varchar(81)
);
...
-- (Véase abajo para la vista actual)
--
CREATE TABLE `vw_resumen_general` (
`idventa` int(11)
,`fkvendedor` int(11)
,`fecha` datetime
,`fkcliente` int(11)
...
-- (Véase abajo para la vista actual)
--
CREATE TABLE `vw_vendedores_ctaspagar` (
`fk` int(11)
,`descripcion` varchar(200)
);
...
--
-- Estructura para la vista `vw_precio_actual_divisa`
--
DROP TABLE IF EXISTS `vw_precio_actual_divisa`;
...
--
-- Indices de la tabla `tbl_abonos`
--
...
--
-- Indices de la tabla `tbl_cierres_diarios_inv`
--
...
ALTER TABLE `tbl_cuentas_bancarias`
  ADD PRIMARY KEY (`idcuenta_bnc`);

--
-- Indices de la tabla `tbl_cuentas_cobrar`
--
ALTER TABLE `tbl_cuentas_cobrar`
  ADD PRIMARY KEY (`idcuenta_cob`),
  ADD KEY `fkventa` (`fkventa`);

--
-- Indices de la tabla `tbl_cuentas_pagar`
--
ALTER TABLE `tbl_cuentas_pagar`
  ADD PRIMARY KEY (`idcuenta_pag`),
  ADD KEY `fkdeuda` (`fkdeuda`);

--
-- Indices de la tabla `tbl_detalles_pedidos`
--
ALTER TABLE `tbl_detalles_pedidos`
  ADD PRIMARY KEY (`iddetalle_ped`),
  ADD KEY `fkpedido` (`fkpedido`),
  ADD KEY `fkproducto` (`fkproducto`);

--
-- Indices de la tabla `tbl_detalles_ventas`
--
...
--
-- Indices de la tabla `tbl_divisas`
--
ALTER TABLE `tbl_divisas`
  ADD PRIMARY KEY (`id_divisa`);

--
-- Indices de la tabla `tbl_fletes`
--
...
--
-- Indices de la tabla `tbl_modalidades_pagos`
--
ALTER TABLE `tbl_modalidades_pagos`
  ADD PRIMARY KEY (`idmodalidad`);

--
-- Indices de la tabla `tbl_nros_cuentas_vendedores`
--
...
--
-- Indices de la tabla `tbl_precios_divisa`
--
ALTER TABLE `tbl_precios_divisa`
  ADD PRIMARY KEY (`idprecio_divisa`);
...
--
-- Indices de la tabla `tbl_precios_ventas_vendedores`
--
...
--
-- Indices de la tabla `tbl_regalias`
--
ALTER TABLE `tbl_regalias`
  ADD PRIMARY KEY (`idregalia`),
  ADD KEY `fkproducto` (`fkproducto`),
  ADD KEY `fkpedido` (`fkpedido`);
...
--
-- AUTO_INCREMENT de la tabla `tbl_abonos`
--
ALTER TABLE `tbl_abonos`
  MODIFY `idabono` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT de la tabla `tbl_auditorias`
--
ALTER TABLE `tbl_auditorias`
  MODIFY `idauditoria` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=216;
--
-- AUTO_INCREMENT de la tabla `tbl_cierres_diarios_inv`
--
ALTER TABLE `tbl_cierres_diarios_inv`
...
--
-- AUTO_INCREMENT de la tabla `tbl_cuentas_bancarias`
--
ALTER TABLE `tbl_cuentas_bancarias`
  MODIFY `idcuenta_bnc` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `tbl_cuentas_cobrar`
--
ALTER TABLE `tbl_cuentas_cobrar`
  MODIFY `idcuenta_cob` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT de la tabla `tbl_cuentas_pagar`
--
ALTER TABLE `tbl_cuentas_pagar`
  MODIFY `idcuenta_pag` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT de la tabla `tbl_detalles_pedidos`
--
ALTER TABLE `tbl_detalles_pedidos`
  MODIFY `iddetalle_ped` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT de la tabla `tbl_divisas`
--
ALTER TABLE `tbl_divisas`
  MODIFY `id_divisa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `tbl_fletes`
--
ALTER TABLE `tbl_fletes`
  MODIFY `idflete` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT de la tabla `tbl_modalidades_pagos`
--
ALTER TABLE `tbl_modalidades_pagos`
...
--
-- AUTO_INCREMENT de la tabla `tbl_precios_divisa`
--
ALTER TABLE `tbl_precios_divisa`
  MODIFY `idprecio_divisa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
-- AUTO_INCREMENT de la tabla `tbl_regalias`
--
ALTER TABLE `tbl_regalias`
  MODIFY `idregalia` int(11) NOT NULL AUTO_INCREMENT;
--
